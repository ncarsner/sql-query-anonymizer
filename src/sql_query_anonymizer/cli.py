...
Examples:
  ...
  sql-anonymizer anonymize -m custom_mappings.json "SELECT * FROM products"
    ...
    deanonymize_parser = subparsers.add_parser("deanonymize", help="De-anonymize SQL query")
    deanonymize_parser.add_argument("query", nargs="?", help="Anonymized query to decode")
    deanonymize_parser.add_argument("-f", "--file", help="Input file with anonymized query")
    ...
    export_parser = subparsers.add_parser("export-mappings", help="Export mappings to file")
    export_parser.add_argument("path", help="Export file path")
    
    import_parser = subparsers.add_parser("import-mappings", help="Import mappings from file")

...
from src.sql_query_anonymizer.utils import Anonymizer, TokenType, preprocess_text
...
class TestAnonymize:
    ...
    @pytest.mark.parametrize("query_key", ["simple_select", "with_joins", "complex_query", "with_literals"])
    def test_anonymize_different_query_types(self, anonymizer, sample_queries, query_key):
...
class TestDeanonymize:
    ...
    @pytest.mark.parametrize("query_key", ["simple_select", "with_joins", "with_literals", "with_functions"])
